...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-18 19:07 UTC*

## 📊 Отчёт о состоянии прокси‑списков (2026‑08‑18 12:34 UTC)

**Вводная:**  
В истории собрано 200 прокси, все они находятся в категории «хороших» (пинг < 1,5 с). Прокси представлены только типом **mtproto** и распределены по четырём регионам.

**Рекомендации:**  
- **EU** — наибольшее количество (144) с самым низким средним пингом 0,05 с; оптимальный выбор для большинства задач.  
- **RU** — хороший вариант для работы с русскоязычными сервисами (46 прокси, avg ping 0,09 с).  
- **US** и **ASIA** — небольшие, но полностью «хорошие» группы (8 и 2 прокси соответственно) – используйте при необходимости гео‑таргетинга.

**Аномалии:**  
Плохих или медленных прокси не обнаружено, а процент «probe‑resistant» = 0 % во всех регионах.
