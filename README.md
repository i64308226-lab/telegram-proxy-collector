...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-19 10:30 UTC*

## 📊 Отчёт о состоянии прокси (2026‑08‑19 12:34 UTC)

- **Вводная:** В базе хранится **200** прокси‑серверов, все они находятся в категории «хороших» (ping < 1.5 с).  
- **Рекомендация:**  
  - **Тип:** используйте исключительно **mtproto**‑прокси — это единственный доступный тип.  
  - **Регион:** большинство (160) находятся в **EU**, далее — **RU** (36) и небольшая часть в **ASIA** (4). Для низкого задержки выбирайте EU/RU, а при необходимости доступа к азиатским ресурсам — ASIA.  
- **Аномалии:** никаких проблем не выявлено — плохих прокси нет, процент «probe‑resistant» = 0 % во всех регионах.
<!-- AI_ANALYTICS_END -->