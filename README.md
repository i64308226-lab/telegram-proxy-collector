...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-19 18:36 UTC*

```markdown
**Отчёт от 2026‑08‑19 12:34 UTC**

- Всего прокси в истории: **200**, все имеют хороший пинг (< 1.5 с).  
- Региональное распределение: **EU – 154**, **RU – 40**, **US – 6**; тип – `mtproto`.  
- Средний пинг: EU 0.06 с, RU 0.10 с, US 0.11 с; процент «probe‑resistant» 0 %.
