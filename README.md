...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-19 22:25 UTC*

## Отчёт о состоянии прокси‑серверов (2026‑08‑19 12:00 UTC)

- **Всего прокси в истории:** 200, все имеют **хорошее** качество (ping < 1.5 с).  
- **Распределение по регионам:** EU — 158, RU — 36, Asia — 4, US — 2.  
- **Типы:** **mtproto** — 200.

### Рекомендация
Для большинства задач лучше использовать **EU‑прокси** (средний ping ≈ 0.07 с) и **RU‑прокси** (средний
<!-- AI_ANALYTICS_END -->