...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-08-18 16:32 UTC*

## Отчёт о состоянии прокси (2026‑08‑18 12:34 UTC)

- **Всего прокси в истории:** 200  
- **Качество:** все 200 прокси находятся в категории «хорошие» (пинг < 1.5 с).  
- **Тип:** 100 % — `mtproto`.  

### Рекомендация по использованию
- **Европа (eu)** – 160 прокси, средний пинг ≈ 0.08 с → оптимальный выбор для большинства задач.  
- **Россия (ru)** – 34 прокси, средний пинг ≈ 0.13 с → хороший вариант для доступа к российским ресурсам.  
- **США (us)** – 4 прокси, средний пинг ≈ 0.14 с → подходит для соединений с американскими сервисами.  
- **Азия (asia)** – 2 прокси, средний пинг ≈ 0.10 с → используйте при необходимости доступа к азиатским сервисам.  

Все прокси имеют одинаковый тип `mtproto` и одинаково высокое качество, поэтому можно свободно выбирать их по региону в зависимости от ваших целей.

### Аномалии
Отсутствуют: нет плохих или медленных прокси, процент «probe‑resistant» = 0 % во всех регионах.
<!-- AI_ANALYTICS_END -->